...
<body>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <!-- Botón Agregar Donación a la izquierda -->
            <button class="btn-agregar" type="button" data-bs-toggle="collapse" data-bs-target="#formDonacion" aria-expanded="false" aria-controls="formDonacion">
                <i class="bx bx-plus-circle"></i> Agregar
            </button>
            <!-- Botón Descargar PDF a la derecha -->
            <button id="pdfDonaciones" class="btn btn-danger" type="button">
                Descargar Reporte <i class="bi bi-file-earmark-pdf"></i>
            </button>
        </div>

        <!-- Formulario colapsable -->
        <div class="collapse mb-4" id="formDonacion">
            <div class="users-form">
                <form action="insert/insert_donaciones.php" method="POST">
                    <input type="text" name="name" placeholder="Nombre" required>
                    <input type="text" name="donacion" placeholder="Donación" required>
        ...
        <div class="users-table">
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_array($query)): ?>
                        <tr>
                            ...
                            <td><a href="actualizar/actualizar-donaciones.php?id=<?= $row['id'] ?>" class="users-table--edit"><i class="bx bx-edit"></i> Editar</a></td>
                            <td><a href="eliminar/eliminar-donaciones.php?id=<?= $row['id'] ?>" class="users-table--delete"><i class="bx bx-trash"></i> Eliminar</a></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
            ...
            <div id="tablaDonacionesPDF" style="display:none;">
                ...
                <div class="solo-pdf-pdf" style="text-align:center; margin-bottom:20px; display:none;">
                    ...
                    <h2 style="font-size:2.1rem; color:#4F5D75; margin-bottom:6px; margin-top:5px;">Reporte de Donaciones</h2>
    ...
    <script>
    document.getElementById("pdfDonaciones").addEventListener("click", function() {
        const tabla = document.getElementById("tablaDonacionesPDF");
